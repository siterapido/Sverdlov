        ...
        <div className="min-h-screen bg-gray-50">
            <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-gray-200">
                <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900">Nova Escala</h1>
                ...
                <motion.form initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-white rounded-none border border-gray-200 p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })}
                                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-none text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500" placeholder="Ex: Escala Janeiro 2026" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium mb-1 text-gray-700">Descrição</label>
                            <textarea rows={3} value={formData.description} onChange={e => setFormData({ ...formData, description: e.target.value })}
                                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-none resize-none text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500" placeholder="Detalhes..." />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-none border border-gray-200 p-6 space-y-4">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            ...
                            <span className="text-sm text-gray-700">Gerar turnos recorrentes</span>
                        </label>
                    </div>
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        <Link href="/escalas" className="px-6 py-3 hover:bg-gray-100 rounded-none font-medium text-gray-700">Cancelar</Link>
