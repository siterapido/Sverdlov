                ...
                <div className="flex gap-2">
                    {[
                        ...
                        <button key={f.value} onClick={() => setFilter(f.value as typeof filter)}
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === f.value ? 'bg-red-500 text-white' : 'bg-white dark:bg-gray-800 border hover:bg-gray-50'}`}>
                            {f.label}
                        </button>
                    ))}
                </div>
                                            ...
                                            {a.status === 'pending' && !isPast && (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button onClick={() => handleDecline(a.id)} disabled={actionLoading === a.id}
                                                        className="flex items-center gap-1 px-3 py-1.5 border border-red-500 text-red-500 rounded-lg text-sm hover:bg-red-50 disabled:opacity-50">
